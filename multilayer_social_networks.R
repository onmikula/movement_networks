...
# 6 # SPATIAL SEPARATION & BOX POSSESSION
# loads a list of rfid records from subsequent time layers
load("data/rfid.RData")
# reads in the module membership information 
modules <- read.table("data/modules.txt")
...
# basic plotting (no information about individuals, no ordering that would reflect the structure of the network)
